...
public class TestControlShop : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            GameObject.Find("Interaction").GetComponent<InteractionShop>().UseGuidance_1 = !GameObject.Find("Interaction").GetComponent<InteractionShop>().UseGuidance_1;
            if (!GameObject.Find("Interaction").GetComponent<InteractionShop>().UseGuidance_1)
            {
        ...
        {
            GameObject.Find("Interaction").GetComponent<InteractionShop>().UseGuidance_2 = !GameObject.Find("Interaction").GetComponent<InteractionShop>().UseGuidance_2;
            if (!GameObject.Find("Interaction").GetComponent<InteractionShop>().UseGuidance_2)
            {
