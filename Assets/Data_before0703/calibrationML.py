...
# Load data from file
data = np.loadtxt('calibration.txt', delimiter=',')
prev_feature = [0] * 350
features, targets = [], []
...
raw_depth = test_features[:, -1]
raw_mse = mean_squared_error(test_targets, raw_depth)
print(f"Raw Mean Squared Error: {raw_mse}")
