...
def plot_density(data_file, axis_type, ax):
    ...
    ax.hist(depth, bins=500, density=True)


# 数据文件列表
data_files = ['./CalibrationTest/0/4/depth.txt', './CalibrationTest/1/5/depth.txt', './CalibrationTest/4/6/depth.txt']  # 假设有3个数据文件
...
plt.savefig('depth_2.png', dpi=300)
